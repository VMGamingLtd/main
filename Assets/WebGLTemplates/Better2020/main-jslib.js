            ...
            if (window.GAO_UnityBrowserChannel) {
                ...
                try {
                    ...
                    if (!window.GAO_UnityBrowserChannel.BaseMessages.sendString) {
                        console.warn("".concat(BaseMessages.CLASS_NAME, ":").concat(FUNC, ": window.GAO_UnityBrowserChannel.BaseMessages.sendString is no yet defined, message not sent"));
                        return;
                    }
