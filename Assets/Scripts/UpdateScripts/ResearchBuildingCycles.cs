...
public class ResearchBuildingCycles : MonoBehaviour
{
    ...
    private ResearchBuildingItemData itemData;
    ...
    private void InitializeBuildingData()
    {
        ...
        itemData = obj.GetComponent<ResearchBuildingItemData>();
    ...
    private void PauseMode()
    {
        ...
        {
            timebarControl = productionCreator.LinkTimebarToBuildingData(null, null, itemData);
        }
        timebarControl.ChangeTimeBarColor(UIColors.timebarColorYellow);
        productionCreator.ChangeProductionItemBackground(UIColors.timebarColorYellow, null, null, itemData);
    ...
    public async UniTask NotEnoughMaterials()
    {
        ...
        productionCreator.ChangeProductionItemBackground(UIColors.timebarColorRed, null, null, itemData);
        itemData.efficiency = 0;
    ...
    public async UniTask StartResearchCycle(CancellationToken cancellationToken)
    {
        ...
        {
            GameObject obj = productionCreator.EnlistResearchBuildingProduction(itemData);
        ...
        productionCreator.ChangeProductionItemBackground(UIColors.blackHalfTransparent, null, null, itemData);
        ...
        {
            if (itemData.spriteIconName == "ResearchDevice")
            {
