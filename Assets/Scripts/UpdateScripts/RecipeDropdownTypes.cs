...
public class RecipeDropdownTypes : MonoBehaviour
{
    ...
    public void OnDropdownValueChanged()
    {
        ...
        switch (optionText)
        {
            ...
            case "所有类型":
            case "Všetky typy":
                RecipeManager.ShowRecipeTypes = "ALL";
                break;
            case "Plants":
            case "Растения":
            case "植物":
            case "Rastliny":
                RecipeManager.ShowRecipeTypes = "PLANTS";
                break;
            case "Liquid":
            case "Жидкость":
            case "液体":
            case "Tekutina":
                RecipeManager.ShowRecipeTypes = "LIQUID";
                break;
            case "Minerals":
            case "Минералы":
            case "矿物质":
            case "Minerály":
                RecipeManager.ShowRecipeTypes = "MINERALS";
                break;
            case "Metals":
            case "Металлы":
            case "金属":
            case "Kovy":
                RecipeManager.ShowRecipeTypes = "METALS";
                break;
            case "Foam":
            case "Пена":
            case "泡沫":
            case "Pena":
                RecipeManager.ShowRecipeTypes = "FOAM";
                break;
            case "Powders":
            case "Порошки":
            case "粉末":
            case "Prášky":
                RecipeManager.ShowRecipeTypes = "POWDERS";
                break;
            case "Flesh":
            case "Плоть":
            case "肉体":
            case "Mäso":
                RecipeManager.ShowRecipeTypes = "FLESH";
                break;
            case "Weapon":
            case "Оружие":
            case "武器":
            case "Zbraň":
                RecipeManager.ShowRecipeTypes = "WEAPON";
                break;
            case "Armor":
            case "Броня":
            case "盔甲":
            case "Zbroj":
                RecipeManager.ShowRecipeTypes = "ARMOR";
                break;
            case "Energy":
            case "Энергия":
            case "能源":
            case "Energia":
                RecipeManager.ShowRecipeTypes = "ENERGY";
                break;
            case "Oxygen":
            case "Кислород":
            case "氧气":
            case "Kyslík":
                RecipeManager.ShowRecipeTypes = "OXYGEN";
                break;
            case "Mining":
            case "Добыча":
            case "采矿":
            case "Ťažba":
                RecipeManager.ShowRecipeTypes = "MINING";
                break;
            case "Bag":
            case "Сумка":
            case "袋子":
            case "Taška":
                RecipeManager.ShowRecipeTypes = "BAG";
                break;
        }
