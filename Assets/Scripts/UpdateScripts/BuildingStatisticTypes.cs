...
public class BuildingStatisticTypes : MonoBehaviour
{
    ...
    public void OnDropdownValueChanged()
    {
        ...
        switch (optionText)
        {
            ...
            case "所有类型":
            case "Všetky typy":
                BuildingStatisticsManager.BuildingStatisticType = "ALL";
                break;
            case "Agriculture":
            case "Cельское хозяйство":
            case "农业设施":
            case "Poľnohospodárstvo":
                BuildingStatisticsManager.BuildingStatisticType = "AGRICULTURE";
                break;
            case "Pumping facility":
            case "Насосная установка":
            case "抽水设施":
            case "Čerpacie zariadenie":
                BuildingStatisticsManager.BuildingStatisticType = "PUMPINGFACILITY";
                break;
            case "Factory":
            case "Фабрика":
            case "工厂":
            case "Fabrika":
                BuildingStatisticsManager.BuildingStatisticType = "FACTORY";
                break;
            case "Comm facility":
            case "Средства связи":
            case "金属":
            case "Komunikačné zariadenie":
                BuildingStatisticsManager.BuildingStatisticType = "COMMFACILITY";
                break;
            case "Storage house":
            case "Складское помещение":
            case "储藏室":
            case "Skladový dom":
                BuildingStatisticsManager.BuildingStatisticType = "STORAGEHOUSE";
                break;
            case "Naval facility":
            case "Военно-морской объект":
            case "海军设施":
            case "Námorné zariadenie":
                BuildingStatisticsManager.BuildingStatisticType = "NAVALFACILITY";
                break;
            case "Oxygen facility":
            case "Кислородная установка":
            case "制氧设施":
            case "Kyslíkové zariadenie":
                BuildingStatisticsManager.BuildingStatisticType = "OXYGENFACILITY";
                break;
            case "Aviation facility":
            case "Авиационный объект":
            case "航空设施":
            case "Letecké zariadenie":
                BuildingStatisticsManager.BuildingStatisticType = "AVIATIONFACILITY";
                break;
            case "Heating facility":
            case "Отопительная установка":
            case "供暖设施":
            case "Vykurovacie zariadenie":
                BuildingStatisticsManager.BuildingStatisticType = "HEATINGFACILITY";
                break;
            case "Cooling facility":
            case "Охлаждающая установка":
            case "冷却设施":
            case "Chladiace zariadenie":
                BuildingStatisticsManager.BuildingStatisticType = "COOLINGFACILITY";
                break;
            case "Powerplant":
            case "Электростанция":
            case "发电厂":
            case "Elektráreň":
                BuildingStatisticsManager.BuildingStatisticType = "POWERPLANT";
                break;
            case "Oxygen station":
            case "Кислород":
            case "氧气站":
            case "Kyslíková stanica":
                BuildingStatisticsManager.BuildingStatisticType = "OXYGENSTATION";
                break;
            case "Mining rig":
            case "Кислородная станция":
            case "采矿设施":
            case "Ťažobné zariadenie":
                BuildingStatisticsManager.BuildingStatisticType = "MININGRIG";
                break;
        }
        BuildingStatisticTypes.BuildingStatisticTypeChanged = true;
