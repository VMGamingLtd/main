...
namespace Friends
{
    ...
    public class FriendsGroupTabAddFriendManager : MonoBehaviour
    {
        ...
        private static string CLASS_NAME = typeof(FriendsGroupTabAddFriendManager).Name;
        ...
        FriendsGroupTabAddFriendManager()
        {
        }
